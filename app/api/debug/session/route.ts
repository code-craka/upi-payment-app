...
import { type DebugSessionResponse, type UserRole, type RoleSyncStatus } from '@/lib/types';
...
export async function GET(
  request: NextRequest,
): Promise<NextResponse<DebugSessionResponse | { error: string; details?: string }>> {
  try {
