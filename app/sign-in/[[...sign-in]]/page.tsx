...
export default function SignInPage() {
  ...
  if (!isLoaded) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50/50 to-indigo-50">
      ...
      <div className="flex min-h-screen items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-gray-600">Sign in to your UPI Dashboard account</p>
          </div>
