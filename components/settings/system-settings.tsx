    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configure how long payment links remain active before expiring</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              className="max-w-xs"
            />
            <p className="text-sm text-muted-foreground">Default: 9 minutes. Range: 1-60 minutes.</p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configure static UPI ID and manage payment app availability</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              If set, this UPI ID will be used for all payment links instead of individual merchant UPI IDs.
            </p>
          </div>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="flex items-center justify-between space-x-2">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Enable Google Pay payment option</p>
                </div>
                <Switch
                  id="gpay"
              ...
              <div className="flex items-center justify-between space-x-2">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Enable PhonePe payment option</p>
                </div>
                <Switch
                  id="phonepe"
              ...
              <div className="flex items-center justify-between space-x-2">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Enable Paytm payment option</p>
                </div>
                <Switch
                  id="paytm"
              ...
              <div className="flex items-center justify-between space-x-2">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Enable BHIM UPI payment option</p>
                </div>
                <Switch
                  id="bhim"
