...
import { Search, Download, Eye, Activity, Shield, CheckCircle, XCircle, Clock, RefreshCw } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Complete activity log with IP tracking and user agent information</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div>
                ...
                <div className="mt-1 p-2 bg-muted rounded">{formatDate(selectedLog.createdAt)}</div>
              </div>
              <div>
                <Label className="text-sm font-medium">User Email</Label>
                <div className="mt-1 p-2 bg-muted rounded">{selectedLog.userEmail}</div>
              </div>
              <div>
                <Label className="text-sm font-medium">User ID</Label>
                <div className="mt-1 p-2 bg-muted rounded font-mono text-sm">{selectedLog.userId}</div>
              </div>
              <div>
                <Label className="text-sm font-medium">Entity Type</Label>
                <div className="mt-1 p-2 bg-muted rounded">{selectedLog.entityType}</div>
              </div>
              <div>
                <Label className="text-sm font-medium">Entity ID</Label>
                <div className="mt-1 p-2 bg-muted rounded font-mono text-sm">{selectedLog.entityId}</div>
              </div>
              <div>
                <Label className="text-sm font-medium">IP Address</Label>
                <div className="mt-1 p-2 bg-muted rounded font-mono text-sm">{selectedLog.ipAddress}</div>
              </div>
            </div>

            <div>
              <Label className="text-sm font-medium">User Agent</Label>
              <div className="mt-1 p-2 bg-muted rounded text-sm break-all">{selectedLog.userAgent}</div>
            </div>
            ...
            {selectedLog.metadata && Object.keys(selectedLog.metadata).length > 0 && (
              <div>
                ...
                <div className="mt-1 p-2 bg-muted rounded">
                  <pre className="text-sm overflow-auto">{JSON.stringify(selectedLog.metadata, null, 2)}</pre>
                </div>
              </div>
            )}
          </CardContent>
